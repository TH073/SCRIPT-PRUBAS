...
#./CREATE_CODEOWNERS_RELEASE.sh #GITHUB_TOKEN 
...
while IFS= read -r line;
    do
       ...
       curl -L \
            ...
            -d "{"message":"codeowners","committer":{"name":"TH073","email":"adam.bouzi@nbn23.tech"},"content":"IyBDT0RFT1dORVJTIGZpbGUNCg0KKiBATkJOMjNkZXYvYXBwcm92ZXJzDQoNCi5naXRodWIvIEBOQk4yM2Rldi9kZXZvcHM=","branch":"$BRANCH"}" 
              #he cambiado las comas simples por doble comas
    done < "$archivo"
